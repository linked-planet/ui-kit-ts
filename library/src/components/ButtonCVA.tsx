...
export const ButtonCVA = forwardRef<HTMLButtonElement, ButtonPropsCVA>(
	(
		{
			label = "",
			title = "",
...
export const LoadingButtonCVA = ({
	...
	onDoubleClick,
	...props
}: ButtonPropsCVA & { loading: boolean; loadingSpinnerClassName?: string }) => {
