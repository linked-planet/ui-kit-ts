...
> = Omit<RSelectProps<OptionType, IsMulti, GroupOptionType>, "name"> & {
...
>({
	...
	name,
	...props
}: SelectWrapperProps<Option, IsMulti, GroupOptionType, FormDataType>) {
	if (control && !name) {
		console.warn("SelectWrapper: control provided but no name")
	}
