...
export const inputBaseStyles = twJoin(
	"min-h-9 rounded box-border w-full relative border-[0.88px] border-input-border placeholder:text-text-subtlest placeholder:opacity-100 bg-input focus-within:bg-input-active border-solid focus-within:border-transparent data-[active=true]:border-transparent data-[invalid=true]:border-transparent ease-in-out transition duration-200 p-0  ",
