...
export const inputBaseStyle = twJoin(
	"min-h-8 rounded w-full relative border border-input-border ease-in-out transition duration-200 p-0 before:pointer-events-none before:z-10 before:content-[''] before:absolute before:-inset-0.5 before:box-border focus-within:before:border-2 focus-within:before:border-input-border-focused before:rounded",
