...
const shadowStyles = twJoin(
	"shadow-borderstyle disabled:shadow-none outline-hidden",
...
export const inputBaseStyles = twJoin(
	"min-h-9 rounded-sm box-border w-full relative border border-input-border placeholder:text-text-subtlest placeholder:opacity-100 bg-input focus-within:bg-input-active border-solid focus-within:border-input-border-focused ease-in-out transition duration-200 p-0  ",
