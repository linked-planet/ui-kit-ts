...
export const inputBaseStyle = twJoin(
	"min-h-8 rounded box-border w-full relative border border-input-border focus-within:border-transparent data-[active=true]:border-transparent data-[invalid=true]:border-transparent ease-in-out transition duration-200 p-0  ",
